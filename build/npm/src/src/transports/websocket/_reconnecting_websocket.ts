 ...
 */
export class ReconnectingWebSocket implements dntShim.WebSocket {
    ...
    private _socket: dntShim.WebSocket;
    ...
    private _onclose: ((this: dntShim.WebSocket, ev: CloseEvent) => any) | null;
    /** WebSocket event handlers for reconnection. */
    private _onerror: ((this: dntShim.WebSocket, ev: Event) => any) | null;
    /** WebSocket event handlers for reconnection. */
    private _onmessage: ((this: dntShim.WebSocket, ev: MessageEvent<any>) => any) | null;
    /** WebSocket event handlers for reconnection. */
    private _onopen: ((this: dntShim.WebSocket, ev: Event) => any) | null;
    ...
    readonly CLOSED = dntShim.WebSocket.CLOSED;
    readonly CLOSING = dntShim.WebSocket.CLOSING;
    readonly CONNECTING = dntShim.WebSocket.CONNECTING;
    readonly OPEN = dntShim.WebSocket.OPEN;

    static readonly CLOSED = dntShim.WebSocket.CLOSED;
    static readonly CLOSING = dntShim.WebSocket.CLOSING;
    static readonly CONNECTING = dntShim.WebSocket.CONNECTING;
    static readonly OPEN = dntShim.WebSocket.OPEN;
